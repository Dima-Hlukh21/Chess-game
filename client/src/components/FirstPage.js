...
const useStyles = makeStyles((theme) => ({
  ...
  button__login: {
    width: "400px",
    background:
      "url(https://media.istockphoto.com/photos/gold-background-golden-polished-metal-with-steel-texture-picture-id1293988705?b=1&k=20&m=1293988705&s=170667a&w=0&h=-GZd0JoIIXFKz9DhsQCLML_F3HYbocrK7UIS4U1LKE8=)",
    padding: "10px 172pX",
    marginTop: "25px",
    border: "none",
    color: "#000",
...
export default function FirstPage() {
  ...
  useEffect(() => {
    ...
    socket.on("ready", (data) => {
      // {gameId, userId, gameBoard, nextStep }
    ...
    <div className={classes.container}>
      <div className={classes.login__container}>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormControl>
            ...
            <Select
              ...
              labelId="color"
              {...register("white")}
              className={classes.dataColor}
            >
              <MenuItem value="true">White</MenuItem>
              <MenuItem value="false">Black</MenuItem>
            </Select>
          </FormControl>
          <button type="submit" className={classes.button__login}>
            Play
          </button>
        </form>
        <img
        ...
        alt="Hufflepuff"
          ...
          src="https://www.freeiconspng.com/uploads/photo-frame-border-png-4.png"
        ></img>
      </div>
    </div>
  );
